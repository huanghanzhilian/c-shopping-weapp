...
let IconFont = ({ name, ...rest }) => {
  switch (name) {
    case 'icon-phone-fill':
      return <IconPhoneFill key="1" {...rest} />
    case 'icon-localpostoffice':
      return <IconLocalpostoffice key="2" {...rest} />
    case 'icon-wallet':
      return <IconWallet key="3" {...rest} />
    case 'icon-ruler':
      return <IconRuler key="4" {...rest} />
    case 'icon-ShoppingCart':
      return <IconShoppingCart key="5" {...rest} />
    case 'icon-location':
      return <IconLocation key="6" {...rest} />
    case 'icon-chat1196057easyiconnet1':
      return <IconChat1196057Easyiconnet1 key="7" {...rest} />
    case 'icon-Officialofficialtext':
      return <IconOfficialofficialtext key="8" {...rest} />
    case 'icon-StomachRuler':
      return <IconStomachRuler key="9" {...rest} />
    case 'icon-delete':
      return <IconDelete key="10" {...rest} />
    case 'icon-minus':
      return <IconMinus key="11" {...rest} />
    case 'icon-round-check_circle_o':
      return <IconRoundCheckCircleO key="12" {...rest} />
    case 'icon-sort':
      return <IconSort key="13" {...rest} />
    case 'icon-filter':
      return <IconFilter key="14" {...rest} />
    case 'icon-plus':
      return <IconPlus key="15" {...rest} />
    case 'icon-save':
      return <IconSave key="16" {...rest} />
    case 'icon-locationcity':
      return <IconLocationcity key="17" {...rest} />
    case 'icon-custom-user':
      return <IconCustomUser key="18" {...rest} />
    case 'icon-clock-circle-o':
      return <IconClockCircleO key="19" {...rest} />
    case 'icon-logout':
      return <IconLogout key="20" {...rest} />
    case 'icon-edit':
      return <IconEdit key="21" {...rest} />
    case 'icon-tubiaozhizuomoban-':
      return <IconTubiaozhizuomoban key="22" {...rest} />
    case 'icon-Comment':
      return <IconComment key="23" {...rest} />
    case 'icon-handbag':
      return <IconHandbag key="24" {...rest} />
    case 'icon-cart':
      return <IconCart key="25" {...rest} />
    case 'icon-notification':
      return <IconNotification key="26" {...rest} />
    case 'icon-search':
      return <IconSearch key="27" {...rest} />
    case 'icon-fontAwesome_star':
      return <IconFontAwesomeStar key="28" {...rest} />
    case 'icon-arrow':
      return <IconArrow key="29" {...rest} />
  }
